...
```
$ kubectl get svc gateway -n gcpdemo
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n gcpdemo
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n gcpdemo
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n gcpdemo
```

and explore the details using

```
$ kubectl get svc exposed-registry -n gcpdemo
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n gcpdemo
```
